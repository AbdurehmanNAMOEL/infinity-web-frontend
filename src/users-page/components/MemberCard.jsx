...
import image from '../../assets/image/Meresa-Hiluf.jpg'
  ...
  return (
    <Card 
      sx={
        ...
        <Typography sx={[cardStyle.memberName,{color:`${isLightMode?'#1e1e1e':'white'}`}]}>{name}</Typography>
        ...
        <Box sx={{width:'100%',height:'50px',display:'flex',gap:'10px',alignItems:'center' ,justifyContent:'center'}}>

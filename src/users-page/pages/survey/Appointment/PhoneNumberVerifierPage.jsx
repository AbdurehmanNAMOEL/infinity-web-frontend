...
import VerificationPage from '../../../auth/auth-rest/pages/VerificationPage';
import { useDispatch, useSelector } from 'react-redux';
import { findPhoneNumber } from '../../../../redux/features/authSlice';
const PhoneNumberVerifierPage= () => {
  ...
  const {isPhoneNumberExist} = useSelector(state=>state.auth)

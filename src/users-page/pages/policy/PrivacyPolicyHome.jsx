  ...
  return (
    <Box sx={
      ...
      <Box sx={style.policyContainer}>
       ...
       <Box sx={[style.termOfServiceContainer,{marginTop:'100px'}]}>
        <Box sx={{width:'100%',height:'auto'}}>
          <Typography  variant='h4' 
           sx={{color:'#1e1e1e',fontWeight:'bold'}}>
            1. Term of services 
            </Typography>
            <Box sx={{width:'100%',height:'auto',borderLeft:5,borderLeftColor:'#1A6CE8',marginTop:'20px',marginLeft:'20px'}}>
      ...
      <Box sx={[style.termOfServiceContainer,{marginLeft:'50px'}]}>
        <Box sx={{width:'100%',height:'auto'}}>
          <Typography  variant='h5' 
           sx={{color:'#1e1e1e',fontWeight:'bold'}}>
            ...
            <Typography  variant='h6' 
              sx={{color:'#1e1e1e',fontWeight:'bold',marginLeft:'20px',marginTop:'20px'}}>
            2.1.1 Who are 'you'? 
            </Typography>
            <Box sx={{width:'100%',height:'auto',borderLeft:5,borderLeftColor:'#1A6CE8',marginTop:'20px',marginLeft:'20px'}}>
              <p style={{padding:'10px',fontSize:'14px'}}>
